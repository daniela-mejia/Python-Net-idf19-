...
int combineStrings(char *sentence1, int sentence1Length, char *sentence2, int sentence2Length, int bufferSize)
{
	...
	//char *rsult = malloc(sentence1Length + sentence2Length + 1);
	//strcpy(sentence2, rsult);
	//strcpy(sentence1, rsult);

	//sentence1 = strcat(rsult, sentence2);

	//printf("Final destination string : |%s|", sentence1);
	//return success;
	//free(rsult);
	else
	{
